...
-- New photo-verification cases must appear on the first bounded Admin page.
...
comment on function public.admin_list_member_photo_verifications(uuid,integer,integer) is
  'Session B Admin photo-verification queue. Newest open cases first with stable id tie-breaker and bounded offset pagination.';
