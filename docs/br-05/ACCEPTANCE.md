...
- [x] Remote and repository migration ledgers contain the same BR-05 privacy migration.
...
- [ ] BR-05 source validation passes on the implementation head.
- [ ] Hosted Supabase rollback E2E passes with no persistent fixture rows.
- [ ] Application CI passes on the implementation head.
- [ ] Database CI passes after a clean reset from all repository migrations.
