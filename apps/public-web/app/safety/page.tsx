...
export const metadata: Metadata = {
  ...
  description: 'Nguyên tắc an toàn, xác thực, chặn, báo cáo và bảo vệ dữ liệu trên Chon.Love.',
  alternates: { canonical: '/safety' },
};

export default function SafetyPage() {
  return <MarketingPage eyebrow="AN TOÀN & QUYỀN RIÊNG TƯ" title="Kiểm soát nhiều hơn trong từng kết nối" lead="Không hệ thống nào loại bỏ hoàn toàn rủi ro. Chon.Love kết hợp xác thực, kiểm duyệt, chặn, báo cáo và phân tách dữ liệu để giảm rủi ro và giúp thành viên kiểm soát trải nghiệm." sections={[
  ...
  ]} cta={{ title: 'Đọc quy tắc cộng đồng', body: 'Mọi thành viên đều phải tuân thủ tiêu chuẩn hành vi và nội dung của Chon.Love.', label: 'Tiêu chuẩn cộng đồng', href: '/community-standards' }} />;
}
