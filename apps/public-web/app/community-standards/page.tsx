...
export const metadata: Metadata = {
  ...
  description: 'Tiêu chuẩn cộng đồng áp dụng cho hồ sơ, ảnh, tin nhắn và hành vi trên Chon.Love.',
  ...
  return (
    <main className="legalPage">
      <article className="legalDocument">
        ...
        <p className="legalLead">Tiêu chuẩn này áp dụng cho hồ sơ, ảnh, tin nhắn, liên kết và mọi nội dung hoặc hành vi trên Chon.Love.</p>

        <h2>1. Chỉ dành cho người từ đủ 18 tuổi</h2>
        <p>Chon.Love không cho phép người dưới 18 tuổi đăng ký hoặc sử dụng nền tảng. Cấm tuyệt đối nội dung hoặc hành vi bóc lột, dụ dỗ, xâm hại, tình dục hóa hoặc khai thác người dưới 18 tuổi.</p>
        ...
        <p>Cấm giả danh cá nhân, nhân viên Chon.Love hoặc tổ chức khác; tạo hồ sơ gây hiểu nhầm; lừa lấy tiền, tài khoản hoặc dữ liệu cá nhân; phát tán liên kết độc hại hoặc thao túng giao dịch.</p>
        ...
        <h2>10. Cách Chon.Love thực thi</h2>
        <p>Tùy mức độ và lịch sử vi phạm, Chon.Love có thể từ chối hoặc gỡ nội dung, hạn chế hiển thị, khóa tính năng, đình chỉ hoặc vô hiệu tài khoản. Nội dung nghiêm trọng có thể được giữ phục vụ điều tra và nghĩa vụ pháp lý.</p>

        <p className="legalUpdated">Hãy sử dụng Chon.Love với sự tôn trọng, trung thực và đồng thuận; không tạo áp lực tài chính hoặc quan hệ đối với người khác.</p>
      </article>
    </main>
  );
}
