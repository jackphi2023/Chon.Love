...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: Array<[string, MetadataRoute.Sitemap[number]['changeFrequency'], number]> = [
    ['/', 'weekly', 1], ['/about', 'monthly', 0.7], ['/how-it-works', 'monthly', 0.8], ['/safety', 'monthly', 0.8],
    ['/premium', 'weekly', 0.8], ['/diamond', 'weekly', 0.8], ['/privacy', 'monthly', 0.5], ['/terms', 'monthly', 0.5], ['/community-standards', 'monthly', 0.6],
  ];
