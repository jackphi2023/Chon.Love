...
export const metadata: Metadata = {
  ...
  description: 'Điều khoản sử dụng Chon.Love dành cho người từ đủ 18 tuổi.',
  ...
  return (
    <main className="legalPage">
      <article className="legalDocument">
        <p className="legalKicker">CHON.LOVE · CẬP NHẬT NGÀY 13/08/2026</p>
        <h1>Điều khoản sử dụng</h1>
        <p className="legalLead">Điều khoản này quy định việc truy cập và sử dụng Chon.Love, nền tảng kết nối chỉ dành cho người từ đủ 18 tuổi trở lên.</p>
        ...
        <h2>2. Mục đích của Chon.Love</h2>
        <p>Chon.Love giúp người trưởng thành tạo hồ sơ, khám phá thành viên phù hợp, thể hiện sự quan tâm và trò chuyện theo các quyền sản phẩm đang được mở.</p>
        <p>Chon.Love không phải dịch vụ mại dâm, môi giới dịch vụ tình dục, chuyển tiền ngang hàng hoặc nền tảng mua bán gặp mặt, tình cảm, quan hệ tình dục hay thông tin liên hệ riêng.</p>
        ...
        <p>Chon.Love có thể hạn chế hiển thị, gỡ nội dung, hạn chế tính năng, đình chỉ hoặc vô hiệu tài khoản khi cần bảo vệ người dùng, điều tra vi phạm, tuân thủ pháp luật hoặc thực thi Tiêu chuẩn cộng đồng.</p>
        ...
        <p>Chon.Love có thể cập nhật Điều khoản khi sản phẩm, pháp luật hoặc yêu cầu vận hành thay đổi. Khi cần, người dùng sẽ được yêu cầu đọc và chấp nhận phiên bản mới.</p>

        <p className="legalUpdated">Việc tiếp tục sử dụng Chon.Love sau khi Điều khoản có hiệu lực đồng nghĩa với việc bạn đồng ý tuân thủ Điều khoản và Tiêu chuẩn cộng đồng hiện hành.</p>
      </article>
    </main>
  );
}
