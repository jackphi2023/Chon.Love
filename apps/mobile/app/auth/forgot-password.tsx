...
export default function ForgotPasswordPage() {
  ...
  return (
    <Screen
      ...
      description="Nhập email tài khoản. Nếu email hợp lệ, MyFan sẽ gửi liên kết đặt lại mật khẩu."
    >
      {sent ? (
        <View style={styles.card}>
          <Text style={styles.title}>Kiểm tra hộp thư</Text>
          <Text style={styles.copy}>
            Yêu cầu đã được tiếp nhận. Vì lý do bảo mật, MyFan luôn hiển thị thông báo này dù email có tồn tại hay không.
          </Text>
      ...
      <View style={styles.noticeCard}>
        ...
        <Text style={styles.noticeCopy}>
          Liên kết chỉ dùng một lần và có thời hạn. Sau khi đặt mật khẩu mới, MyFan sẽ thu hồi toàn bộ phiên đăng nhập để bạn đăng nhập lại.
        </Text>
      </View>
    </Screen>
  );
