...
// Each icon uses a viewBox close to its painted bounds. The CSS image box remains the
// product contract (18px desktop/tablet, 15px phone), while the artwork no longer sits
// inside an unnecessary 48px canvas that made some symbols look materially smaller.
