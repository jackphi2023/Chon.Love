...
const styles = StyleSheet.create({
  ...
  ready: { color: chonColors.success },
  ...
  blocker: { backgroundColor: chonColors.softPink, borderRadius: 10, color: chonColors.text, fontSize: 12, lineHeight: 18, padding: 10, textAlign: 'center' },
  ...
  notice: { color: chonColors.success, fontSize: 12, fontWeight: '700', lineHeight: 18, textAlign: 'center' },
  ...
  bankForm: { backgroundColor: chonColors.softPink, borderRadius: 12, gap: 9, padding: 12 },
  ...
  statusOpen: { backgroundColor: chonColors.softPink, color: chonColors.primaryRed },
  statusPaid: { backgroundColor: chonColors.goldChrome, color: chonColors.text },
  statusClosed: { backgroundColor: chonColors.surfaceMuted, color: chonColors.muted },
