...
const styles = StyleSheet.create({
  ...
  photoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 24 }, photoTile: { aspectRatio: 0.8, backgroundColor: '#E7E5E4', borderRadius: 9, flexBasis: '23.8%', flexGrow: 1, maxWidth: '24%', minWidth: 120, overflow: 'hidden', position: 'relative' }, photoTileImage: { height: '100%', width: '100%' }, photoTileFallback: { alignItems: 'center', height: '100%', justifyContent: 'center', width: '100%' }, photoHeart: { alignItems: 'center', backgroundColor: 'rgba(8,23,38,0.52)', borderRadius: 17, bottom: 6, height: 34, justifyContent: 'center', position: 'absolute', right: 6, width: 34 },
