...
describe('BR-08 KYC and withdrawal operational contract', () => {
  ...
  it('requires dual-control and evidence fields in the queue contract', () => {
    const row = withdrawalQueueItemSchema.parse({
      withdrawal_id: crypto.randomUUID(), creator_id: crypto.randomUUID(), display_name: 'Creator', status: 'processing',
